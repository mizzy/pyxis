...
.PHONY: run-0.6b run-1.7b bench-0.6b bench-1.7b bench-0.6b-metal bench-1.7b-metal bench-0.6b-q8 bench-1.7b-q8 bench-0.6b-q4 bench-1.7b-q4
...
bench-0.6b-metal:
	cargo run --release -- $(MODEL_0_6B) $$'$(PROMPT)' --bench --metal

bench-1.7b-metal:
	cargo run --release -- $(MODEL_1_7B) $$'$(PROMPT)' --bench --metal
...
bench-0.6b-q4:
	cargo run --release -- $(MODEL_0_6B) $$'$(PROMPT)' --bench --quantize-int4

bench-1.7b-q4:
	cargo run --release -- $(MODEL_1_7B) $$'$(PROMPT)' --bench --quantize-int4
